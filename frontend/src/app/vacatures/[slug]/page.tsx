...
export default async function VacancyDetailPage({ params }: Props) {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: vacancy.title, item: `https://zorgwerkwijzer.nl/vacatures/${vacancy.slug}` },
    ],
  };
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-6">
                ...
                <p className="text-center text-xs text-slate-400 mt-3">
                  Solliciteer in 60 seconden via Zorgwerkwijzer.
                </p>
              </div>

              {/* Werkgever card */}
              <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-6">
                <h3 className="font-bold text-slate-900 mb-4">Over de werkgever</h3>
                <div className="flex items-center gap-3 mb-4">
                  {vacancy.employerLogoUrl ? (
                    ...
                    <img
                      ...
                      className="w-12 h-12 rounded-xl border border-slate-200 object-contain p-1 bg-white"
                    />
                  ) : (
